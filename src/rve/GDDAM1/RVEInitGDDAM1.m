%-------------------------------------------------------------------------%
% [D,RVEdofs] = RVEInitGDDAM1(idx,MacroSpaceDim,RVEdata) initialises a
% gradient damage RVE with an inclusion and computes the homogenised 
...
function [D,RVEdofs] = RVEInitGDDAM1(idx,MacroSpaceDim,RVEdata)
...
switch RVEdata.SpaceDim
    ...
    case 2
        ...
        model.param.set('E_mat', '20[GPa]');
        model.param.set('nu_mat', '0.2');
        model.param.set('hmax', '1.5e-2[mm]');
        model.param.set('sigmat', '10 [MPa]');
        model.param.set('epsf', '0.008');
        ...
        model.component('comp1').geom('geom1').feature('e1').set('semiaxes', [0.05 0.225]);
        ...
        model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('softeningInput', 'modelParameter');
        model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('epsf', 'epsf');
        model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('sigmap_mat', 'userdef');
        model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('sigmap', 'sigmat');
%         model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('MazDmgEvoT', 'Mazars');
%         model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('eps0t', '1.2e-4');
%         model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('At', 1.09);
%         model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('Bt', 1500);
%         model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('eps0c', 1);
%         model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('Ac', 1.09);
%         model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('Bc', 1500);
        model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('regType', 'impGradient');
        model.component('comp1').physics('solid').feature('lemm1').feature('dmg1').set('lint', '1.5e-2 [mm]');
        model.component('comp1').physics('solid').feature('constr1').set('constraintExpression', '-du+eps_xx*dx*t+eps_xy*dy*t');
        ...
        model.component('comp1').physics('solid').feature('constr2').set('constraintExpression', '-dv+eps_xy*dx*t+eps_yy*dy*t');
