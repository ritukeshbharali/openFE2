...
% Restart directory (do not add path)
dir_restart = './restart';
sub_dir     = 'Step40';
...
% Mesh
% inp_macro.problem.mesh_file = 'mesh2sq.msh';
...
% Number of steps
inp_macro.solver.nsteps = 3;

% Initial step-size
inp_macro.solver.initstepsize = 1e-5;
...
inp_macro.restart.steps = [50 100];
